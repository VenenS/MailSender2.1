...
namespace GeneratedCode
{
    ...
    {
        public string AddSender { get; set; } = "Добавление получателя";
        public string RemoveSender { get; set; } = "Удаление получателя";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00020FC5", RsidRunAdditionDefault = "0032703B" };
            ...
            Run run1 = new Run() { RsidRunProperties = "0032703B" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "0032703B", RsidRunAdditionDefault = "0032703B" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "0032703B", RsidParagraphAddition = "0032703B", RsidRunAdditionDefault = "0032703B" };
            ...
            Run run2 = new Run() { RsidRunProperties = "0032703B" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "0032703B", RsidR = "0032703B" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            ActiveWritingStyle activeWritingStyle1 = new ActiveWritingStyle() { Language = "ru-RU", VendorID = (UInt16Value)64U, DllVersion = 131078, NaturalLanguageGrammarCheck = true, CheckStyle = false, ApplicationName = "MSWord" };
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00A01A2B" };
            Rsid rsid1 = new Rsid() { Val = "00020FC5" };
            Rsid rsid2 = new Rsid() { Val = "0032703B" };
            Rsid rsid3 = new Rsid() { Val = "00A01A2B" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "4E175A5E" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{6CDF6A90-2026-4AAB-9546-BF1BD240ECCF}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(fontSize6);
        ...
        {
            document.PackageProperties.Creator = "Nikolay";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "3";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-10-15T10:56:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-10-15T10:56:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Nikolay";
        }
